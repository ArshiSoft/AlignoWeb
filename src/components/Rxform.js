        ...
        <div className="row d-flex justify-content-center align-items-center h-100">
          <div className="Col-12 col-md-9 col-lg-7 col-sm-6 col-xl-6" style={{ width: `900px` }}>
                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div className="form-outline mb-4">
                      ...
                      <label className="form-label" for="form3Example1cg">Name of Clinic <span>*</span></label>
                      <input
                        type="text"
            ...
            {formik.errors.clinicname ? formik.errors.clinicname : null}
                  ...
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example3cg">Name of Doctor <span>*</span></label>
            ...
            {formik.errors.doctorname ? formik.errors.doctorname : null}
                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example1cg">Doctors Number <span>*</span></label>
            ...
            {formik.errors.doctornumber ? formik.errors.doctornumber : null}
                  ...
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example3cg">Doctor's Email <span>*</span></label>
            ...
            {formik.errors.doctoremail ? formik.errors.doctoremail : null}
                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example1cg">Patient's ID <span>*</span></label>
            ...
            {formik.errors.patientid ? formik.errors.patientid : null}
                  ...
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example3cg">Patients Name <span>*</span></label>
            ...
            {formik.errors.nameofpatient ? formik.errors.nameofpatient : null}
                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example4cg">Patient's Phone Number <span>*</span></label>
            ...
            {formik.errors.patientnumber ? formik.errors.patientnumber : null}
                  ...
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example4cdg">Patient's Email <span>*</span></label>
            ...
            {formik.errors.patientemail ? formik.errors.patientemail : null}
                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example4cdg">Select Gender <span>*</span></label>
                  ...
                  <div class="col">
                    <div className="form-outline mb-4">
                      <label className="form-label" for="form3Example4cdg">Email <span>*</span></label>
