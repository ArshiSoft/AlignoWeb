...
// import {useIinventoryUIContext} from './UIContext'
...
// 						<div
// 							className='Col-12 col-md-9 col-lg-7 col-sm-6 col-xl-6'
// 							style={{ width: `900px` }}>
// 							<div
// 								style={{
// 									margin: `10px`,
...
//         PROSTA_ID: tempData?.customerDetails?.PROSTA_ID || "",
...
//       CODE: Yup.string().required("Postal Code is a required field"),
...
//       PROSTA_ID: Yup.string().required("Province/State is a required field"),
